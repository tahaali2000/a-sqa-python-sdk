...
from spotifywebapiwithfixesandimprovementsfromsonallux.models.album_type_enum import AlbumTypeEnum
    ...
    def validate(cls, dictionary):
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(value=dictionary.album_type,
                                           type_callable=lambda value: AlbumTypeEnum.validate(value)) \
